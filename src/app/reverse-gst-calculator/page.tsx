...
export const metadata: Metadata = {
  title: 'Reverse GST Calculator — Extract GST from Total Amount',
  description: 'Free Reverse GST Calculator to extract GST from a tax-inclusive amount. Find the original price before GST was added.',
};
